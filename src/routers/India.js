...
const India = () => {
            ...
            if(response.data.code === "200")
            {
              ...
              fetch(getTrendingNewsApi)
                ...
                fetch(getIndiaNewsApi)
                    ...
                    .catch(error => console.log(error))
      }}).catch(error => console.log(error))}}, [window.location.href]);
    ...
    useEffect(() => {
        ...
        const getIndiaNewsApi = 'http://172.29.38.107:8082/minions/search/trendingNews?start=51&recordscount=50&wt=json&category=India&user='+useremail;
